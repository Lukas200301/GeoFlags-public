    ...
    <div class="card p-8 md:p-12">
      ...
      >
        ...
        <p v-if="correctAnswerName" class="text-gray-400">
          ...
          <span class="text-rose-400 font-semibold">{{ correctAnswerName }}</span>
        </p>
      </div>
      ...
      >
        <div
          class="bg-gradient-to-br from-rose-500/20 to-purple-500/20 border border-rose-500/50 rounded-xl p-6"
        >
