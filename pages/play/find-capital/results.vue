  ...
  <div class="max-w-4xl mx-auto">
    <div class="card p-8 md:p-12">
      ...
      >
        ...
        <NuxtLink to="/leaderboard?mode=find-capital" class="btn-secondary px-6 py-3">
      ...
      >
        <div class="bg-gray-800/50 rounded-xl p-4 text-center border border-gray-700">
          <Icon name="mdi:map-marker" class="w-8 h-8 text-sky-500 mx-auto mb-2" />
          <p class="text-gray-400 text-sm">Capitals Found</p>
...
/**
 * Find the Capital - Results Screen
...
const { finalScore, correctAnswerName, submitScore, resetGame } = useFindTheCapital()
...
const getScoreMessage = (score: number): string => {
  ...
  if (score >= 50) return 'Excellent! You really know your capitals!'
  ...
  return 'Keep learning! Every capital is a step forward!'
}
