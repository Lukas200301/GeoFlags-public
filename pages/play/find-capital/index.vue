        ...
        <div class="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
          ...
          <ul class="space-y-3 text-gray-300">
            <li class="flex items-start gap-3">
              <Icon name="mdi:earth" class="w-5 h-5 text-sky-500 mt-0.5 flex-shrink-0" />
              <span>A country name and flag will be displayed</span>
            </li>
            <li class="flex items-start gap-3">
              <Icon name="mdi:crosshairs-gps" class="w-5 h-5 text-sky-500 mt-0.5 flex-shrink-0" />
              <span>Click on the map where you think the capital city is located</span>
            </li>
            <li class="flex items-start gap-3">
            ...
            <li class="flex items-start gap-3">
              ...
              <span>The game continues infinitely until you miss</span>
            </li>
            <li class="flex items-start gap-3">
              <Icon name="mdi:trophy" class="w-5 h-5 text-amber-500 mt-0.5 flex-shrink-0" />
              <span>Your final score is the number of correct locations in a row</span>
            </li>
          </ul>
        </div>
        ...
        <div class="bg-sky-500/10 rounded-xl p-6 border border-sky-500/30">
          ...
          <ul class="space-y-2 text-gray-300 text-sm">
            <li class="flex items-start gap-2">
              ...
              <span>Study the geography of different continents</span>
            </li>
            <li class="flex items-start gap-2">
              <span class="text-sky-500">•</span>
              <span>Zoom in for better accuracy on the map</span>
            </li>
            <li class="flex items-start gap-2">
              <span class="text-sky-500">•</span>
              <span>Capital cities are usually near the center or coast of countries</span>
            </li>
          </ul>
        </div>
      </div>
...
const { startGame } = useFindTheCapital()
...
const handleStartGame = async () => {
  try {
    ...
    router.push('/play/find-capital/game')
  } catch (err: any) {
