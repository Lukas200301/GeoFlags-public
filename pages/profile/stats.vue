    ...
    <div v-else-if="stats" class="space-y-6">
      ...
      <div v-if="stats && stats.totalGames > 0" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="glass-card p-6">
          ...
          <div
            v-if="stats?.performanceOverTime && stats.performanceOverTime.length > 0"
            class="h-64"
          >
            <LineChart
        ...
        <div class="glass-card p-6">
          <h2 class="text-xl font-semibold gradient-text mb-4">
            Recent Games Performance (Last 20)
          </h2>
          <div v-if="stats?.recentGames && stats.recentGames.length > 0" class="h-64">
            <RecentGamesChart :games="recentGamesLimited" />
          </div>
          <div v-else class="h-64 flex items-center justify-center text-gray-500">
            <div class="text-center">
        ...
        <div class="glass-card p-6">
          ...
          <div
            v-if="stats?.averageScoresByMode && Object.keys(stats.averageScoresByMode).length > 0"
            class="h-64"
          >
            <BarChart
        ...
        <div class="glass-card p-6">
          ...
          <div
            v-if="stats?.gamesPerMode && Object.keys(stats.gamesPerMode).length > 0"
      ...
      <div class="glass-card p-6">
        ...
        <div
          v-if="stats?.highScores && Object.keys(stats?.highScores).length > 0"
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          >
            <Icon
              ...
              :class="(stats?.totalGames || 0) >= 1 ? 'text-primary-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              name="mdi:trophy"
              class="w-12 h-12 mx-auto mb-2"
              :class="(stats?.totalGames || 0) >= 10 ? 'text-secondary-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              name="mdi:medal"
              class="w-12 h-12 mx-auto mb-2"
              :class="(stats?.totalGames || 0) >= 50 ? 'text-green-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              name="mdi:crown"
              class="w-12 h-12 mx-auto mb-2"
              :class="(stats?.totalGames || 0) >= 100 ? 'text-purple-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              name="mdi:fire"
              class="w-12 h-12 mx-auto mb-2"
              :class="(stats?.totalGames || 0) >= 500 ? 'text-amber-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              name="mdi:star"
              class="w-12 h-12 mx-auto mb-2"
              :class="(stats?.averageScore || 0) >= 80 ? 'text-yellow-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              name="mdi:diamond"
              class="w-12 h-12 mx-auto mb-2"
              :class="(stats?.averageScore || 0) >= 95 ? 'text-pink-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              name="mdi:counter"
              class="w-12 h-12 mx-auto mb-2"
              :class="(stats?.totalScore || 0) >= 100 ? 'text-blue-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              name="mdi:chart-line"
              class="w-12 h-12 mx-auto mb-2"
              :class="(stats?.totalScore || 0) >= 500 ? 'text-cyan-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              name="mdi:rocket"
              class="w-12 h-12 mx-auto mb-2"
              :class="(stats?.totalScore || 0) >= 1000 ? 'text-orange-400' : 'text-gray-600'"
            />
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (stats?.gamesPerMode?.GUESS_FLAG || 0) >= 25 ? 'text-red-400' : 'text-gray-600'
              "
            />
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (stats?.gamesPerMode?.TIME_TRIAL || 0) >= 25 ? 'text-indigo-400' : 'text-gray-600'
              "
            />
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (stats?.gamesPerMode?.FIND_CAPITAL || 0) >= 25 ? 'text-teal-400' : 'text-gray-600'
              "
            />
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (stats?.gamesPerMode?.HIGHER_LOWER || 0) >= 25 ? 'text-purple-400' : 'text-gray-600'
              "
            />
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (stats?.gamesPerMode?.SILHOUETTE || 0) >= 25 ? 'text-rose-400' : 'text-gray-600'
              "
            />
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (stats?.highScores?.GUESS_FLAG || 0) >= 50 ? 'text-rose-400' : 'text-gray-600'
              "
            />
          ...
          <table class="w-full">
            ...
            <tbody>
              ...
              >
                ...
                <td class="py-3 px-4">
                  <span
                    class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium bg-primary-500/20 text-primary-300"
                  >
