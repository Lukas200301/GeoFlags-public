<template>
  <div class="max-w-7xl mx-auto">
    ...
    <div class="flex justify-center mb-6">
      <div class="inline-flex bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 rounded-xl p-1 shadow-lg">
        <button
          @click="viewMode = 'list'"
          :class="[
    ...
    <div v-if="viewMode === 'globe'" class="mb-8">
      <div class="h-[700px]">
        <ClientOnly>
          ...
          />
          <template #fallback>
            <div class="flex items-center justify-center h-full bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 rounded-2xl">
    ...
    <div v-else>
    <!-- Search and Filters -->
    <div class="bg-gray-900/50 backdrop-blur-xl border border-gray-800/50 rounded-2xl p-6 mb-8 shadow-2xl">
      ...
      <div class="mt-4 pt-4 border-t border-gray-800/50">
        <p class="text-sm text-gray-400">
          Showing <span class="font-semibold text-primary-400">{{ filteredCountries.length }}</span> of
    ...
    >
      ...
      >
        ...
        <!-- Country Info -->
        <div class="p-4">
          <h3 class="text-lg font-bold text-gray-100 mb-1 group-hover:text-primary-400 transition-colors">
            {{ country.name }}
          </h3>
        ...
        <!-- Hover Indicator -->
        <div class="h-1 bg-gradient-to-r from-primary-600 to-secondary-600 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></div>
      </NuxtLink>
    </div>
