<template>
  <div class="max-w-7xl mx-auto">
    ...
    <div v-else-if="publicProfile" class="space-y-6">
      <div class="glass-card p-8">
        <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
          <div class="relative">
            ...
            >
              <img
                v-if="publicProfile?.avatarUrl"
                :src="getAvatarUrl(publicProfile.avatarUrl)"
                alt="Avatar"
            ...
            <div class="flex flex-wrap gap-4 justify-center md:justify-start mt-4">
              <div class="flex items-center gap-2 text-sm">
                ...
                <span class="text-gray-300"
                  >Joined {{ formatDate(publicProfile?.createdAt || '') }}</span
                >
              </div>
            </div>
          </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              <p class="text-3xl font-bold text-gray-100">
                {{ publicProfile?.stats.totalGames || 0 }}
              </p>
        ...
        <div class="glass-card p-6">
          <div class="flex items-center gap-4">
            ...
            <div>
              <p class="text-3xl font-bold text-gray-100">
                {{ (publicProfile?.stats.totalScore || 0).toLocaleString() }}
              </p>
        ...
        <div class="glass-card p-6">
          <div class="flex items-center gap-4">
            ...
            <div>
              <p class="text-3xl font-bold text-gray-100">
                {{ publicProfile?.stats.averageScore || 0 }}
              </p>
      ...
      <div
        v-if="Object.keys(publicProfile?.stats.highScores || {}).length > 0"
        class="glass-card p-8"
      >
        <h3 class="text-2xl font-bold text-gray-100 mb-6">High Scores by Mode</h3>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div
            v-for="(score, mode) in publicProfile?.stats.highScores"
            :key="mode"
      ...
      <!-- Charts Section -->
      <div
        v-if="publicProfile?.stats.totalGames && publicProfile.stats.totalGames > 0"
      ...
      >
        ...
        <div class="glass-card p-6">
          ...
          <div
            v-if="Object.keys(publicProfile?.stats.gamesPerMode || {}).length > 0"
            class="h-64 flex items-center justify-center"
          >
            <DoughnutChart :labels="gamesDistributionLabels" :data="gamesDistributionData" />
          </div>
        ...
        <div class="glass-card p-6">
          ...
          <div
            v-if="
              publicProfile?.stats.averageScoresByMode &&
              Object.keys(publicProfile.stats.averageScoresByMode).length > 0
            "
            class="h-64"
          >
            <BarChart
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div
            :class="[
              ...
              (publicProfile?.stats.totalGames || 0) >= 1
          ...
          >
            <Icon
              ...
              :class="
                (publicProfile?.stats.totalGames || 0) >= 1 ? 'text-primary-400' : 'text-gray-600'
              "
            />
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.totalGames || 0) >= 10
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.totalGames || 0) >= 50
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (publicProfile?.stats.totalGames || 0) >= 50 ? 'text-green-400' : 'text-gray-600'
              "
            />
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.totalGames || 0) >= 100
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (publicProfile?.stats.totalGames || 0) >= 100 ? 'text-purple-400' : 'text-gray-600'
              "
            />
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.totalGames || 0) >= 500
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (publicProfile?.stats.totalGames || 0) >= 500 ? 'text-amber-400' : 'text-gray-600'
              "
            />
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.averageScore || 0) >= 80
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (publicProfile?.stats.averageScore || 0) >= 80 ? 'text-yellow-400' : 'text-gray-600'
              "
            />
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.averageScore || 0) >= 95
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (publicProfile?.stats.averageScore || 0) >= 95 ? 'text-pink-400' : 'text-gray-600'
              "
            />
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.totalScore || 0) >= 100
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (publicProfile?.stats.totalScore || 0) >= 100 ? 'text-blue-400' : 'text-gray-600'
              "
            />
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.totalScore || 0) >= 500
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (publicProfile?.stats.totalScore || 0) >= 500 ? 'text-cyan-400' : 'text-gray-600'
              "
            />
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.totalScore || 0) >= 1000
          ...
          >
            <Icon
              ...
              class="w-12 h-12 mx-auto mb-2"
              :class="
                (publicProfile?.stats.totalScore || 0) >= 1000 ? 'text-orange-400' : 'text-gray-600'
              "
            />
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              publicProfile?.stats.gamesPerMode &&
              Object.keys(publicProfile?.stats.gamesPerMode).length >= 3
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.gamesPerMode?.GUESS_FLAG || 0) >= 25
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.gamesPerMode?.TIME_TRIAL || 0) >= 25
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.gamesPerMode?.FIND_CAPITAL || 0) >= 25
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.gamesPerMode?.HIGHER_LOWER || 0) >= 25
                ? 'glass-card-dark border-purple-500/50'
                : 'glass-card-dark opacity-50',
            ]"
          >
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.gamesPerMode?.SILHOUETTE || 0) >= 25
          ...
          <div
            :class="[
              'text-center p-4 rounded-xl border transition-all',
              (publicProfile?.stats.highScores?.GUESS_FLAG || 0) >= 50
                ? 'glass-card-dark border-rose-500/50'
                : 'glass-card-dark opacity-50',
            ]"
          >
          ...
          <div
            :class="[
              ...
              publicProfile?.stats.gamesPerMode &&
              Object.keys(publicProfile?.stats.gamesPerMode).length >= 3 &&
              Object.values(publicProfile?.stats.gamesPerMode).every((count: number) => count >= 10)
          ...
          >
            <Icon
              ...
              :class="
                publicProfile?.stats.gamesPerMode &&
                Object.keys(publicProfile?.stats.gamesPerMode).length >= 3 &&
                Object.values(publicProfile?.stats.gamesPerMode).every(
      ...
      <div
        v-if="publicProfile?.gameHistory && publicProfile.gameHistory.length > 0"
        class="glass-card p-8"
      >
          ...
          <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-800">
              <tr v-for="game in paginatedHistory" :key="game.id" class="hover:bg-gray-800/30">
                ...
                <td class="py-3 px-4">
                  <span
                    class="inline-flex items-center gap-2 px-3 py-1 bg-primary-500/20 text-primary-300 rounded-full text-sm"
                  >
                    <Icon :name="getGameModeIcon(game.mode)" class="w-4 h-4" />
                    {{ formatModeName(game.mode) }}
                  </span>
                </td>
                <td class="py-3 px-4 text-center text-lg font-bold text-gray-100">
                  {{ game.score }}
                </td>
              </tr>
            </tbody>
...
const fetchPublicProfile = async () => {
  try {
    loading.value = true
    error.value = null
    const data = await apiRequest<PublicUserProfile>(`/api/users/${userId}`, {
      method: 'GET',
      requiresAuth: false,
    })
...
const averageScoresModeLabels = computed(() => {
  ...
  return Object.keys(publicProfile.value.stats.averageScoresByMode).map((mode) =>
    formatModeName(mode)
  )
})
